...
class OAuthConfig:
    ...
    def __init__(self):
        ...
        # OAuth client configuration (GOOGLE_CLIENT_* matches gateway / Next.js naming)
        self.client_id = os.getenv("GOOGLE_OAUTH_CLIENT_ID") or os.getenv(
            "GOOGLE_CLIENT_ID"
        )
        self.client_secret = os.getenv("GOOGLE_OAUTH_CLIENT_SECRET") or os.getenv(
